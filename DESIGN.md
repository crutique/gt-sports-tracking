...
Two presentations, chosen by surface role (confirmed 2026-07-21):
- **Bust cards (4:5 rounded rectangles)** on every visual surface — score cards, the outlook field, staff panel, player heroes. Head and shoulders, sized to be recognizable; this is what "highly visual" means for people.
- **Circles only as identity chips** in dense reference rows (tables, lists), never as the featured presentation.
